...
/**
 *This class allow identify whether the cases of a type of injury have increased or decreased by a percentage calculation, the percentage calculation is determined by calculating a percentage by row, by column or in based on the total of the data.
 * @author SANTOS
 */
...
/**
 * This method is responsible of delete  all records that have saved for a previous cross of variables.
 */
...
/**
 * This function is responsible of realize a calculation on a matrix of results A when a cross of variables of an indicator is performed, this calculation is performed for the first time period selected by the user.
 * @param type
 * @param col
 * @param row
 * @return 
...
/**
 * This function is responsible of realize a calculation on a matrix of results B when a cross of variables of an indicator is performed, this calculation is performed for the second time period selected by the user.
 * @param type
 * @param col
 * @param row
 * @return 
...
/**
 * This method is responsible of create the matrix of results with the percentage difference between the 2 period ranges selected.
 */
