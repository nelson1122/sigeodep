...
public class RecordSetsTransitMB implements Serializable {
    ...
    void loadValues(RowDataTable[] selectedRowsDataTableTags) {
        ...
        for (int i = 0; i < tagsList.size(); i++) {
            rowCountAux = rowCountAux + fatalInjuryTrafficFacade.countTraffic(tagsList.get(i).getTagId());
        ...
        table_model = new LazyRecordSetsDataModel(rowCountAux, sqlTags, FormsEnum.SCC_F_029);
    }
    ...
    public void postProcessXLS(Object document) {
        try {
            ...
            while (resultSet.next()) {
                ...
                RowDataTable rowDataTableList = connection.loadFatalInjuryTraafficRecord(resultSet.getString(1));
                rowPosition++;
