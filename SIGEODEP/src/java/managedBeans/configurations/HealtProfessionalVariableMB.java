...
public class HealtProfessionalVariableMB implements Serializable {
    ...
    public void postProcessXLS(Object document) {
        ...
        for (int i = 0; i < healthProfessionalsList.size(); i++) {
            ...
            createCell(row, 0, healthProfessionalsList.get(i).getHealthProfessionalId().toString());//CODIGO
            createCell(row, 1, healthProfessionalsList.get(i).getHealthProfessionalName());//NOMBRE            
        }
    }
