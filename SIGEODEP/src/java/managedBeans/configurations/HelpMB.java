...
public class HelpMB implements Serializable {
    ...
    public void onNodeSelect(NodeSelectEvent event) {
        ...
        switch (pageId) {
            ...
            case 113:
                ...
                break;
            case 1131:
                helpTitle = "1.1.3.1 Relacion de variables";
                RequestContext.getCurrentInstance().execute("handleMyNodeClick('help/default.html')");
                //RequestContext.getCurrentInstance().execute("handleMyNodeClick('help/1131.html')");
                break;
            case 1132:
                helpTitle = "1.1.2.2 Relacion de valores";
                RequestContext.getCurrentInstance().execute("handleMyNodeClick('help/default.html')");
            ...
            case 121:
                ...
                break;
            case 122:
                helpTitle = "1.2.2 Muertes pos accidentes de tránsito";
                RequestContext.getCurrentInstance().execute("handleMyNodeClick('help/default.html')");
            ...
            case 32:
                ...
                break;
            case 33:
                helpTitle = "3.3 Gestión de Ususarios";
                RequestContext.getCurrentInstance().execute("handleMyNodeClick('help/default.html')");
            ...
            case 42:
                ...
                break;
            case 43:
                helpTitle = "4.3 Conexion inicial";
                RequestContext.getCurrentInstance().execute("handleMyNodeClick('help/default.html')");
    ...
    public HelpMB() {
        ...
        TreeNode node_1_1_3_1 = new DefaultTreeNode("document", new Document("1.1.3.1 Relacion de variables", "1131", "Word Document"), node_1_1_3);
        TreeNode node_1_1_3_2 = new DefaultTreeNode("document", new Document("1.1.2.2 Relacion de valores", "1132", "Word Document"), node_1_1_3);
        ...
        TreeNode node_1_2_2 = new DefaultTreeNode("document", new Document("1.2.2 Muertes pos accidentes de tránsito", "122", "Word Document"), node_1_2);
        ...
        TreeNode node_1_3_2 = new DefaultTreeNode("document", new Document("1.3.2 Agrupar conjuntos", "132", "Word Document"), node_1_3);
        ...
        //----------------------------------------------------------------------
        TreeNode node_3 = new DefaultTreeNode(new Document("3. Configuraciónes", "3", "Folder"), root);
        ...
        TreeNode node_3_3 = new DefaultTreeNode("document", new Document("3.3 Gestión de Ususarios", "33", "Folder"), node_3);
        ...
        TreeNode node_4_3 = new DefaultTreeNode("document", new Document("4.3 Conexion inicial", "43", "Folder"), node_4);
