...
public class FromWhereSumbitedVariableMB implements Serializable {
    ...
    public void postProcessXLS(Object document) {
        ...
        for (int i = 0; i < nonFatalDataSourcesFromWhereList.size(); i++) {
            ...
            createCell(row, 0, nonFatalDataSourcesFromWhereList.get(i).getNonFatalDataSourcesFromWhereId().toString());//CODIGO
            createCell(row, 1, nonFatalDataSourcesFromWhereList.get(i).getNonFatalDataSourcesFromWhereName());//NOMBRE            
        }
    }
