...
//    private SelectItem[] murderContexts;
    ...
    private String currentInvolvedVehicles;
    //-------------------- 
    @EJB
...
//            }
	    ...
	    //medidas de sehuridad
            List<ProtectiveMeasures> protectiveMeasuresList = protectiveMeasuresFacade.findAll();
            protectiveMeasures = new SelectItem[protectiveMeasuresList.size()];
            for (int i = 0; i < protectiveMeasuresList.size(); i++) {
                protectiveMeasures[i] = new SelectItem(protectiveMeasuresList.get(i).getProtectiveMeasuresId(), protectiveMeasuresList.get(i).getProtectiveMeasuresName());
            }
...
//            }
	    ...
	    //tipos de vias
            ...
            roadTypes = new SelectItem[roadTypesList.size()];
            for (int i = 0; i < roadTypesList.size(); i++) {
                roadTypes[i] = new SelectItem(roadTypesList.get(i).getRoadTypeId(),roadTypesList.get(i).getRoadTypeName());
            }
	    //Clases de accidentes
            List<AccidentClasses> accidentClassesList = accidentClassesFacade.findAll();
            accidentClasses = new SelectItem[accidentClassesList.size()];
            for (int i = 0; i < accidentClassesList.size(); i++) {
                accidentClasses[i] = new SelectItem(accidentClassesList.get(i).getAccidentClassId(),accidentClassesList.get(i).getAccidentClassName());
            }
	    //caracteristicas de la victima
            List<VictimCharacteristics> victimCharacteristicsList = victimCharacteristicsFacade.findAll();
            victimCharacteristics = new SelectItem[victimCharacteristicsList.size()];
            for (int i = 0; i < victimCharacteristicsList.size(); i++) {
                victimCharacteristics[i] = new SelectItem(victimCharacteristicsList.get(i).getCharacteristicId(), victimCharacteristicsList.get(i).getCharacteristicName());
            }
...
//            }
	    ...
	    //Tipos de servicio
            ...
            serviceTypes = new SelectItem[serviceTypesList.size()];
            for (int i = 0; i < serviceTypesList.size(); i++) {
                serviceTypes[i] = new SelectItem(serviceTypesList.get(i).getServiceTypeId(),serviceTypesList.get(i).getServiceTypeName());
            }
	    
	    //Vehiculos involucrados en el accidente
            List<InvolvedVehicles> involvedVehiclesList = involvedVehiclesFacade.findAll();
            involvedVehicles = new SelectItem[involvedVehiclesList.size()];
            for (int i = 0; i < involvedVehiclesList.size(); i++) {
                involvedVehicles[i] = new SelectItem(involvedVehiclesList.get(i).getInvolvedVehicleId(), involvedVehiclesList.get(i).getInvolvedVehicleName());
            }
...
//    }
    ...
    public String getCurrentRoadType() {
	return currentRoadType;
    }

    public void setCurrentRoadType(String currentRoadType) {
    ...
    public String getCurrentAccidentClasses() {
	return currentAccidentClasses;
    }

    public void setCurrentAccidentClasses(String currentAccidentClasses) {
    ...
    public String getCurrentInvolvedVehicles() {
	return currentInvolvedVehicles;
    }

    public void setCurrentInvolvedVehicles(String currentInvolvedVehicles) {
	this.currentInvolvedVehicles = currentInvolvedVehicles;
    }
